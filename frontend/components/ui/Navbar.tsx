    ...
    <>
        ...
        <div className="w-full px-5 lg:px-16">
          <div className="flex justify-between items-center h-[88px] md:h-[110px]">
            ...
            <div className="hidden lg:flex items-center gap-4 xl:gap-6 ml-6">
              ...
              <NavLink href="/guide" current={pathname}>{t("common.nav.guide") || "Guide"}</NavLink>
              <NavLink href="/directory" current={pathname}>{t("common.nav.directory") || "Directory"}</NavLink>
      ...
      >
        ...
        <nav className="flex flex-col items-center justify-center flex-1 gap-2 px-6 overflow-y-auto py-8">
          ...
          <MobileLink href="/guide" onClick={() => setIsOpen(false)}>{t("common.nav.guide") || "Guide"}</MobileLink>
          <MobileLink href="/directory" onClick={() => setIsOpen(false)}>{t("common.nav.directory") || "Directory"}</MobileLink>
          <MobileLink href="/news" onClick={() => setIsOpen(false)}>{t("common.nav.news") || "News"}</MobileLink>
